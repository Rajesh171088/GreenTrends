...
public class WebActionUtility {
	 ...
	 * @throws Throwable 
	 */
	public void waitForTextToBePresent(WebDriver driver ,  WebElement element,String text) throws Throwable {
	
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(TIMEOUT));
		wait.until(ExpectedConditions.textToBePresentInElement(element, text));
	}
	
	public void waitForElement(WebDriver driver) throws InterruptedException
	{		
		Thread.sleep(2000);
	}
	...
	/**
	 * Its an explicit wait always waits for alertpopup before clicking on it
	 * 
	 */
	public void waitForAlertPopUp(WebDriver driver ) throws Throwable {
	...
	/**
	 * used to Switch to Alert Window & click on accept button
	 * @param driver
	 */
	 ...
	 * @param value
	 */
	public void selectBasedOnValue(WebElement element , String text) {
		Select sel = new Select(element);
